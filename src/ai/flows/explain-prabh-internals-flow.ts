...
const ExplainPrabhInternalsInputSchema = z.object({
  topic: z.string().describe('The specific internal system, algorithm, or concept the user wants Prabh to explain (e.g., "Prabh\'s core learning algorithm", "My adaptive neural architecture", "How my ethical reasoning works").'),
});
...
const explanationPrompt = ai.definePrompt({
  ...
  prompt: `The user is asking you to explain a part of your own conceptual internal systems, AI architecture, or unique algorithms.
